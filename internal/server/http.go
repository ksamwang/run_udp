...
func (a *App) httpMux() http.Handler {
	...
	admin.Any("/lan/learned-paths", ginWrap(a.requireAdmin(a.handleAdminLANLearnedPaths)))
	admin.Any("/lan/diagnostics", ginWrap(a.requireAdmin(a.handleAdminLANDiagnostics)))
